    ...
    return (
        <Box p={3} sx={{ marginTop: '80px', marginBottom: '-15px', display: { xs: 'none', md: 'flex' } }}>
            <div className='breadcrumbs'>
                ...
                <Box sx={{
                    display: 'flex', justifyContent: 'space-between', width: '100vw', alignItems: 'end',mt: '1%'
                }}>
                    <Typography flex={1} variant='h6' sx={{ fontSize: '14px' }}>
                        <b>FILTERS</b>
                    </Typography>
                    <Box flex={4} className="drop2">
 
 
                        <NativeSelect
                            sx={{ borderRadius: '10px', fontWeight: '300', color: 'black', fontSize: '14px', overflow: 'hidden' }}
                            disableUnderline
                            defaultValue={10}
                            inputProps={{
                                name: 'age',
                        ...
                        <NativeSelect
                            sx={{ borderRadius: '8px', fontWeight: '300', color: 'black', fontSize: '14px', overflow: 'hidden', width: 'fint' }}
                            disableUnderline
                            defaultValue={10}
                            inputProps={{
                                name: 'age',
                    ...
                    <Box flex={1.8} className="drop3">
                        <FormControl sx={{ minWidth: 280, paddingRight: '20px', marginLeft:'20%' }} size='small'>
                            ...
                            >
                                ...
                                <MenuItem value={10}><Typography sx={{ display: 'flex', alignItems: 'center', position:'absolute' }}>
